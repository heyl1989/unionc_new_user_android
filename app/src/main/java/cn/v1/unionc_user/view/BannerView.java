...
import cn.v1.unionc_user.ui.adapter.BannerAdapter;
        ...
        if (viewList != null && viewList.size() != 0) {
            if (mLinearPosition.getChildCount() != viewSize) {
                ...
                for (int i = 0; i < diffCnt; i++) {
                    if (needAdd) {
                        ...
                        img.setBackgroundResource(R.drawable.banner_circle);
            ...
            for (int i = 0; i < mLinearPosition.getChildCount(); i++) {
                if (i == (curPos % viewSize)) {
                    mLinearPosition.getChildAt(i).setBackgroundResource(R.drawable.banner_circle_select);
                } else {
                    mLinearPosition.getChildAt(i).setBackgroundResource(R.drawable.banner_circle);
                }
            }
        }
    }
